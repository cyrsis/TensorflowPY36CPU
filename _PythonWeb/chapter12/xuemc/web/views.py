...
#    form.message = form.data
    if request.method == 'POST' and form.validate():
        ...
        logic.LoadBasePageInfo('修改學校','輸入並確定',form)
    else:
        logic.LoadBasePageInfo('新增學校','輸入並確定',form)
...
#    form.message = form.data
    ...
    form = PageInfo()
    logic.LoadBasePageInfo('所有學校','檢視',form)
...
#    form.message = form.data
    if request.method == 'POST' and form.validate():
        ...
        logic.LoadBasePageInfo('修改教育訓練機構','輸入並確定',form)
    else:
        logic.LoadBasePageInfo('新增教育訓練機構','輸入並確定',form)
...
#    form.message = form.data
    ...
    form = PageInfo()        
    logic.LoadBasePageInfo('所有教育訓練機構','檢視',form)
...
def view_bulletin():
    ...
    if request.method == 'POST' and form.validate():
        ...
        logic.LoadBasePageInfo('修改公告','輸入並確定',form)
    else:
        form.dt.data = datetime.datetime.now()
        logic.LoadBasePageInfo('新增公告','輸入並確定',form)
...
def view_bulletins():
    ...
    form = PageInfo()        
    logic.LoadBasePageInfo('所有公告','檢視',form)
...
def view_account():
    ...
    if request.method == 'POST' and form.validate():
        ...
        logic.LoadBasePageInfo('修改使用者','輸入並確定',form)
    else:
        logic.LoadBasePageInfo('新增使用者','輸入並確定',form)
...
def view_accounts():
    ...
    form = PageInfo()        
    logic.LoadBasePageInfo('所有使用者','檢視',form)
