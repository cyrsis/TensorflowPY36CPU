...
COMMENT ON TABLE client IS '֕拐ŏⱭ㺍
device_token㺉豸«
os㺲ٗ珵ͳ㬈ᖵandroid/ios';
...
'can_enum:
true: ״̬㬓Сctuator_state
false:lиֵ᭴
max_value&min_value: ᾫey儈ᖵ綎獊
alarm_type: 
0㺲늇瀇荊10㺖딚⼷䌬ς覾20㺈κΊẲ漸澯';
...
alarm_level:⎼뤥vice_state᭵ġlarm_leveleʶ';
...
template: ȧ㺛apartment]Ӛ[time]碉꛴ype]覾ǫ˙똣ᣨƤ֐[xxx]ʇ阼엖㩧;
...
insert into message_template(language_id,account_id,sensor_model_id,template) values(null,null,null,'[apartment]Ӛ[time]碉꛴ype]覾裡;
