...
english_sentences = load_text_file(
    'K:\\TensorflowPY36CPU\\TensorflowPY36CPU\\Data\\en_data')
french_sentences = load_text_file(
    'K:\\TensorflowPY36CPU\\TensorflowPY36CPU\\Data\\fr_data')
